...
Процедура РассчитатьОтпускные()
	...
	ТаблицаДанных.Колонки.Добавить("ОтработаноЧасов");
	...
	ТаблицаДанных.Свернуть("НомерСтроки, ДатаНачала, ДатаОкончания", "РезультатОклад, ОтработаноЧасов, РезультатПремия");
