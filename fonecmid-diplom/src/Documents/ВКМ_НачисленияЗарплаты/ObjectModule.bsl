...
Ошибка говорит о том, что программа ищет поле с именем Результат в регистре основных начислений, а его там нет.

Судя по вашему предыдущему коду, в вашем регистре ВКМ_ОсновныеНачисления ресурсы названы с префиксом ВКМ_ (например, ВКМ_Результат, ВКМ_ОтработаноДней).

Вам нужно исправить имена полей в Запросе внутри процедуры РассчитатьОтпускные.

Исправленная процедура РассчитатьОтпускные
Замените старый код на этот. Я исправил имена полей Результат -> ВКМ_Результат и ОтработаноДней -> ВКМ_ОтработаноДней.
