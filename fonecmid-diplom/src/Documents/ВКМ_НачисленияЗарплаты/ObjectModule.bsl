...
Процедура ОбработкаПроведения(Отказ, Режим)
    ...
    // если формируются движения → Записать()
...
Процедура РассчитатьОтпускные()
   ...
   Движения.ВКМ_ФактическиеОтпуска.Записывать = Истина;
    ...
    Для Каждого Строка Из ТаблицаДанных Цикл
        ...
        //  Запись в Регистр Накопления (Факт дней для отчета) [НОВОЕ]
        ДвижениеФакт = Движения.ВКМ_ФактическиеОтпуска.Добавить();
        ДвижениеФакт.Период = Дата; // Или Строка.ДатаНачала, зависит от задачи
        ДвижениеФакт.ВКМ_Сотрудник = Строка.Сотрудник;
        ДвижениеФакт.ВКМ_Дней = ДнейОтпуска; // Имя ресурса в вашем регистре
