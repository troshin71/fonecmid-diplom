...
Запрос = Новый Запрос;
	...
	Пока Выборка.Следующий() Цикл
		...
		// Получаем данные из запроса (они уже очищены от NULL)
	...
	// Финальная запись (сохраняем и Оклад, и Отпускные)
	Движения.ВКМ_ОсновныеНачисления.Записать();
