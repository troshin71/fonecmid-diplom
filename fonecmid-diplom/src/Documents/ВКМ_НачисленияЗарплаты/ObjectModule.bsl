...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	// 3. Формирование остальных движений (отпуск и т.д.)
	...
	// ! ВАЖНО: Добавил вызов расчета НДФЛ
	РассчитатьНДФЛ();
	
	// 7. Финальная запись всех регистров
	Движения.ВКМ_ОсновныеНачисления.Записать();
	// Остальные регистры (ДопНачисления, Удержания) записываются внутри своих процедур
