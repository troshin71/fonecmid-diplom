...
Процедура РассчитатьОтпускные()
	...
	|	
	|	// !!! ИСПРАВИЛ ЗДЕСЬ: Берем ДНИ из ресурса ВКМ_ОтработаноДней
	...
	// !!! ИСПРАВИЛ ЗДЕСЬ: Колонка теперь хранит дни
	...
	// !!! ИСПРАВИЛ ЗДЕСЬ: Сворачиваем по Дням
	...
	Для Каждого СтрокаИтог Из ТаблицаДанных Цикл
		...
		ДниБазы   = СтрокаИтог.ОтработаноДней; // Теперь тут дни
		
		// Проверка на корректность дат отпуска
		...
		Если ДниБазы > 0 Тогда
			// Формула: (Все Деньги / Все Отработанные Дни)
