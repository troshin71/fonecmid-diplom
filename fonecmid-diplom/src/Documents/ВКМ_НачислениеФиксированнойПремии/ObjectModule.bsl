Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого Строка Из СписокСотрудников Цикл
		...
		ДвижениеНач.Сотрудник = Строка.Сотрудник;
		...
		ДвижениеНач.Результат = Строка.СуммаПремии;
		...
		ДвижениеУдерж.Сотрудник = Строка.Сотрудник;
		...
		ДвижениеВзаиморасчет.Сотрудник = Строка.Сотрудник;
		ДвижениеВзаиморасчет.Сумма = Строка.СуммаПремии - СуммаНДФЛ;
