...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	////ВКМ_Добавление профилей групп доступа.
	

	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "ВКМ_Менеджер";
	ОписаниеПрофиля.Идентификатор = "63d7e820-5621-4f12-9c3a-895420d9b4a1";
	...
	ОписаниеПрофиля.Идентификатор = "63d7e820-5621-4f12-9c3a-895420d9b4a8";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Кадровик-расчетчик (ВКМ)'", ОбщегоНазначения.КодОсновногоЯзыка());
	
	
	ОписаниеПрофиля.Роли.Добавить("ВКМ_КадровикРасчётчик"); 
	...
	ОписаниеПрофиля.Идентификатор = "8a2f3b1c-9d4e-47a5-b2c6-1f0e8a9b3d5c";
	...
	ОписаниеПрофиля.Идентификатор = "c4d5e6f7-1a2b-3c4d-5e6f-7a8b9c0d1e2f";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Бухгалтер (ВКМ)'", ОбщегоНазначения.КодОсновногоЯзыка());
